...
If no value is in the hastags, the user didn't send any values for that specific question/option. Make sure that at the end of each workout day you describe each exerice shortly and concisely. Make sure to have intensive workouts."""
